...
@app_views.route('/api/v1/amenities', method=['GET'], strict_slashes=False)
...
@app_views.route('/api/v1/amenities/<int:amenity_id>', methods=['GET'],
...
@app_views.route('/api/v1/amenities/<int:amenity_id>', method=['DELETE'],
                 strict_slashes=False)
...
@app_views.route('/api/v1/amenities/<int:amenity_id>', methods=["PUT"],
                 strict_slashes=False)
