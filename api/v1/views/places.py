...
@app_views.route('/api/v1/cities/<int:city_id>/places', method=['GET'],
...
@app_views.route('/api/v1/places/<int:place_id>', method=['DELETE'],
                 strict_slashes=False)
...
@app_views.route('/api/v1/cities/<int:city_id>/places', methods=['POST'],
                 strict_slashes=False)
